...
(()=>{
  ...
  async function load(file){
    ...
    await new Promise((resolve,reject)=>{
      ...
      script.src=new URL(file,source).href+'?build='+(file==='stainher-v1524-home-layout.js'?'20260909-r24-devengo-al-consultar-home':'20260907-d20-r19-restauracion-funcional-integral');script.async=false;script.dataset.stainherModule=file;
