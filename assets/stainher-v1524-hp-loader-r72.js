/* Stainher V15.24 · R118 · cargador único y secuencial para módulos autenticados.
...
(()=>{
  'use strict';
  if(window.__STAINHER_HP_LOADER_VERSION__==='R118')return;
  window.__STAINHER_HP_LOADER_R72__=true;
  window.__STAINHER_HP_LOADER_VERSION__='R118';

  const BUILD='20260925-r118-correctivo-history';
  ...
  const api={refresh,refreshBudgets,refreshLeadership,refreshSystem,refreshSignature,refreshFreeReport,refreshContractForecast,refreshTurnReport,refreshAccessR107,refreshVehicleExpiryR109,refreshCorrectivoHistoryR118};
  ...
  api.bootstrapR112=bootstrapR118;
  api.bootstrapR115=bootstrapR118;
  api.bootstrapR116=bootstrapR118;
  api.bootstrapR117=bootstrapR118;
  api.bootstrapR118=bootstrapR118;
  bootstrapR118().catch(error=>console.error('[Stainher Runtime R118]',error));
})();
