/* Stainher V15.24 · R72 · cargador HP anti-cache.
...
(()=>{
  ...
  async function refresh(){
    try{
      await load('stainher-weekly-hp-runtime-r72','stainher-v1524-weekly-hp-report.js');
      await load('stainher-hp-history-runtime-r72','stainher-v1524-hp-history-r71.js');
      await load('stainher-weekly-hp-router-r72','stainher-v1524-hp-router-r57.js');
      window.dispatchEvent(new CustomEvent('stainher:hp-r72-ready'));
    }catch(error){
      console.error('[Stainher HP R72]',error);
    }
  }
