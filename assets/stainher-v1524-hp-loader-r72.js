/* Stainher V15.24 · R92 · puente anti-cache HP + Presupuestos + Liderazgo + Sistema + Firmas + Informes.
 ...
 * y Comunicados / Informes libres R92.
 * No contiene lógica de login/sesión ni modifica cálculos HP.
 */
(()=>{
  'use strict';
  if(window.__STAINHER_HP_LOADER_VERSION__==='R92')return;
  window.__STAINHER_HP_LOADER_R72__=true;
  window.__STAINHER_HP_LOADER_VERSION__='R92';
  ...
  async function refreshBudgets(){
    try{
      await load('stainher-presupuestos-runtime-r92','stainher-presupuestos-r80.js');
      await load('stainher-presupuestos-pdf-footer-runtime-r92','stainher-presupuestos-pdf-footer-r84.js');
      await load('stainher-presupuestos-grid-runtime-r92','stainher-presupuestos-grid-r85.js');
      await load('stainher-presupuestos-router-runtime-r92','stainher-presupuestos-router-r82.js');
  ...
  async function refreshLeadership(){
    try{
      await load('stainher-leadership-mail-runtime-r92','stainher-v1524-leadership-mail.js');
      await load('stainher-leadership-record-pdf-runtime-r92','stainher-v1524-leadership-record-pdf-r86.js');
      await load('stainher-leadership-program-delete-runtime-r92','stainher-v1524-leadership-program-delete-r86.js');
      await load('stainher-leadership-dom-actions-runtime-r92','stainher-v1524-leadership-dom-actions-r87.js');
      await load('stainher-leadership-mail-after-save-runtime-r92','stainher-v1524-leadership-mail-after-save-r88.js');
  ...
  async function refreshSystem(){
    try{
      await load('stainher-system-cleanup-runtime-r92','stainher-v1524-system-cleanup-r89.js');
  ...
  async function refreshSignature(){
    try{
      await load('stainher-signature-profile-runtime-r92','stainher-v1524-signature-profile-r90.js');
      await load('stainher-signature-mobile-runtime-r92','stainher-v1524-signature-mobile-r91.js');
  ...
  async function refreshFreeReport(){
    try{
      await load('stainher-free-report-runtime-r92','stainher-v1524-free-report-r92.js');
      window.StainherFreeReportR92?.install?.();
      window.dispatchEvent(new CustomEvent('stainher:free-report-r92-ready'));
    }catch(error){
      console.error('[Stainher Comunicados/Informes R92]',error);
    }
  }
