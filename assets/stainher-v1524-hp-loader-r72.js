/* Stainher V15.24 · R91 · puente anti-cache HP + Presupuestos + Liderazgo + Sistema + Firmas.
 ...
 * limpieza visual de Sistema R89, firma personal R90 y expansión móvil R91.
 * No contiene lógica de login/sesión ni modifica cálculos HP.
 */
(()=>{
  'use strict';
  if(window.__STAINHER_HP_LOADER_VERSION__==='R91')return;
  window.__STAINHER_HP_LOADER_R72__=true;
  window.__STAINHER_HP_LOADER_VERSION__='R91';

  const BUILD='20260916-r91-signature-mobile-expand';
  ...
  async function refreshBudgets(){
    try{
      await load('stainher-presupuestos-runtime-r91','stainher-presupuestos-r80.js');
      await load('stainher-presupuestos-pdf-footer-runtime-r91','stainher-presupuestos-pdf-footer-r84.js');
      await load('stainher-presupuestos-grid-runtime-r91','stainher-presupuestos-grid-r85.js');
      await load('stainher-presupuestos-router-runtime-r91','stainher-presupuestos-router-r82.js');
  ...
  async function refreshLeadership(){
    try{
      await load('stainher-leadership-mail-runtime-r91','stainher-v1524-leadership-mail.js');
      await load('stainher-leadership-record-pdf-runtime-r91','stainher-v1524-leadership-record-pdf-r86.js');
      await load('stainher-leadership-program-delete-runtime-r91','stainher-v1524-leadership-program-delete-r86.js');
      await load('stainher-leadership-dom-actions-runtime-r91','stainher-v1524-leadership-dom-actions-r87.js');
      await load('stainher-leadership-mail-after-save-runtime-r91','stainher-v1524-leadership-mail-after-save-r88.js');
  ...
  async function refreshSystem(){
    try{
      await load('stainher-system-cleanup-runtime-r91','stainher-v1524-system-cleanup-r89.js');
  ...
  async function refreshSignature(){
    try{
      await load('stainher-signature-profile-runtime-r91','stainher-v1524-signature-profile-r90.js');
      await load('stainher-signature-mobile-runtime-r91','stainher-v1524-signature-mobile-r91.js');
