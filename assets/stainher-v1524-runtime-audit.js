...
(()=>{
  ...
  function ensureHomeVisibilityFix(){
    ...
    script.src='stainher-v1524-home-visibility-fix.js?build=20260911-r38-home-user-card-only';
    script.async=false;
