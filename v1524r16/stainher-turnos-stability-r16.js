...
(function installStainherTurnosStabilityR16(){
  ...
  function mountStyle(){
    ...
    s.textContent=`
      ...
      #page-turnos .v1512-turn-legend.v1524-compact-legend{display:flex!important;align-items:center!important;gap:5px!important;width:100%!important;max-width:100%!important;margin:7px 0 8px!important;padding:6px 7px!important;box-sizing:border-box!important;overflow-x:auto!important;overflow-y:hidden!important;border:1px solid #2c3a48!important;border-radius:9px!important;background:#0d151e!important;white-space:nowrap!important;scrollbar-width:thin}
      #page-turnos .v1524-compact-legend span{display:inline-flex!important;align-items:center!important;gap:4px!important;flex:0 0 auto!important;color:#c4d0dc!important;font-size:9px!important;line-height:1.1!important}
      #page-turnos .v1524-compact-legend .v1524-legend-label{padding-right:3px!important;color:#8fa3b7!important;font-size:8px!important;font-weight:800!important;text-transform:uppercase!important;letter-spacing:.05em!important}
      #page-turnos .v1524-compact-legend .v1524-legend-separator{width:1px!important;height:19px!important;margin:0 2px!important;background:#314151!important}
      #page-turnos .v1524-compact-legend i{display:inline-flex!important;align-items:center!important;justify-content:center!important;min-width:24px!important;height:20px!important;padding:0 5px!important;border-radius:6px!important;box-sizing:border-box!important;font-style:normal!important;font-size:9px!important;font-weight:900!important;line-height:1!important}
      #page-turnos .v1524-compact-legend .v1512-shift{min-width:20px!important;width:auto!important}
      #page-turnos .v1512-event-badge{border-radius:6px!important;font-weight:900!important;box-sizing:border-box!important}
      ${eventCss}
      @media(max-width:700px){#page-turnos .v1512-turn-legend.v1524-compact-legend{margin:5px 0 7px!important;padding:5px 6px!important;gap:4px!important}#page-turnos .v1524-compact-legend span{font-size:8px!important}#page-turnos .v1524-compact-legend i{height:19px!important;min-width:23px!important;font-size:8px!important}}
    `;
  ...
  function normalizeBadges(root){
    root?.querySelectorAll?.('.v1512-event-badge').forEach(badge=>{
      const code=eventCodeFromBadge(badge);if(!code)return;
      ...
      if(row){EVENT_CODES.forEach(c=>row.classList.remove('event-'+c));row.classList.add('event-'+code)}
    });
  }
  ...
  function ensureStableLegend(){
    ...
    const table=matrix?.querySelector(':scope > table');
    if(matrix&&table){
  ...
  function patchRenderer(){
    ...
    wrapped.__v16TurnStable=true;wrapped.__base=current;window.renderTurnosV15=wrapped;return true;
  }
