...
Deno.serve(async (req: Request) => {
  try {
    ...
    // verify_jwt=true ya protege la función a nivel de plataforma. getClaims valida
    // además el token sin depender de que la sesión siga almacenada en GoTrue.
    ...
    // Todas las lecturas técnicas se hacen con service_role. El usuario nunca
    // recibe esta clave y la función sigue restringida a Administrador/Confiabilidad.
