...
window.STAINHER_BUILD = 'V15.24-20260903-consolidated-r22';
...
(function installStainherCoreLoader(){
  const MODULES=Object.freeze([
    {id:'turnos-v1524-script',src:'turnos-v1524.js?v=20260903-r22',domain:'turnos'},
    {id:'stainher-v1524-final-script',src:'stainher-v1524-final.js?v=20260903-r22',domain:'core'},
    {id:'stainher-v1524-hotfix1-script',src:'stainher-v1524-hotfix1.js?v=20260903-r22',domain:'turnos'},
    {id:'stainher-v1524-hotfix2-script',src:'stainher-v1524-hotfix2.js?v=20260903-r22',domain:'turnos'},
    {id:'stainher-v1524-hotfix3-script',src:'stainher-v1524-hotfix3.js?v=20260903-r22',domain:'turnos'},
    {id:'stainher-v1524-report-hotfix4-script',src:'stainher-v1524-report-hotfix4.js?v=20260903-r22',domain:'informes'},
    {id:'stainher-v1524-home-badges-compact-script',src:'stainher-v1524-home-badges-compact.js?v=20260903-r22',domain:'inicio'},
    {id:'stainher-v1524-contract-money-fit-script',src:'stainher-v1524-contract-money-fit.js?v=20260903-r22',domain:'contrato'},
      {id:'stainher-v1524-turn-views-personal-script',src:'stainher-v1524-turn-views-personal-summary.js?v=20260903-r22',domain:'turnos'},
      {id:'stainher-v1524-vacation-balance-script',src:'stainher-v1524-vacation-balance.js?v=20260903-r22',domain:'vacaciones'},
      {id:'stainher-v1524-ux-runtime-script',src:'stainher-v1524-ux-runtime.js?v=20260903-r22',domain:'experiencia'},
      {id:'stainher-v1524-reliability-actions-script',src:'stainher-v1524-reliability-actions.js?v=20260903-r22',domain:'confiabilidad'},
      {id:'stainher-v1524-admin-crud-script',src:'stainher-v1524-admin-crud.js?v=20260903-r22',domain:'administracion'},
      {id:'stainher-v1524-theme-script',src:'stainher-v1524-theme.js?v=20260903-r22',domain:'tema'},
      {id:'stainher-v1524-runtime-audit-script',src:'stainher-v1524-runtime-audit.js?v=20260903-r22',domain:'diagnostico'}
  ]);
