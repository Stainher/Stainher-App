 ...
 */
(function installD11RecoveryLoader(){
  if(window.__STAINHER_D11_RECOVERY_LOADER__)return;
  window.__STAINHER_D11_RECOVERY_LOADER__=true;
  ...
  const files=[
    'stainher-v1524-hotfix1.js','stainher-v1524-hotfix2.js',
    'stainher-turnos-stability-r17.js','stainher-v1524-report-hotfix4.js',
    'stainher-v1524-home-badges-compact.js','stainher-v1524-contract-money-fit.js',
    'stainher-v1524-turn-views-personal-summary.js','stainher-v1524-vacation-balance.js',
    'stainher-v1524-ux-runtime.js','stainher-v1524-reliability-actions.js',
    'stainher-v1524-admin-crud.js','stainher-v1524-theme.js',
    'stainher-v1524-runtime-audit.js','stainher-reliability-charts-dark-r19.js',
    'stainher-v1524-signature-upload.js','../stainher-justificativos-r19.js'
  ];
  let chain=Promise.resolve();
  for(const file of files)chain=chain.then(()=>new Promise((resolve,reject)=>{
    const clean=file.replace(/^\.\.\//,'').replace(/\.js$/,''),id=`stainher-d11-${clean}`;
  ...
  chain.catch(error=>console.error('[Stainher d11]',error));
})();
